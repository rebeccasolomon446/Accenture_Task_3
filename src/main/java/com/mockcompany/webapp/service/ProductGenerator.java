...
public class ProductGenerator {
    ...
    public ProductGenerator(@Value("classpath:/images/*.png") Resource[] productImages) {
        // Class takes an array of Resource objects representing product images as a constructor argument.
        // The @value annotation is used to specify the path of the product images.
        this.productImages = productImages;
        // class may be used to generate a collection of product objects, where each product contains a randomly selected product imaage
        //from the array of images, as well as a random name, desc, price, and other attributes.
    }
